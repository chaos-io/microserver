...
type ClientService interface {
	...
	GetProduct(params *GetProductParams, opts ...ClientOption) (*GetProductCreated, error)
...
/*
  GetProduct get a product details
*/
func (a *Client) GetProduct(params *GetProductParams, opts ...ClientOption) (*GetProductCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*GetProductCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
